...
Tags: elementor, elementor addons, elementor widgets, page builder, widgets
...
1. Make sure the free **Elementor** plugin is installed and activated.
2. Upload the `free-widgets-for-elementor` folder to the `/wp-content/plugins/` directory, or install it through the **Plugins → Add New** screen.
3. Activate the plugin through the **Plugins** screen in WordPress.
4. Edit any page with Elementor — you'll find the new widgets under the **Free Widgets** category at the top of the widget panel.

== Frequently Asked Questions ==

= Does this plugin require Elementor? =

Yes. It extends the free Elementor page builder, so Elementor must be installed and active. Elementor Pro is **not** required.

= Is it really 100% free? =

Yes. There is no Pro version, no upsell, no license system, and no feature is locked behind a paywall.

= Will it slow down my site? =

No. A widget's stylesheet and script are loaded only on the specific pages where that widget is used, so visitors never download CSS or JS they don't need.
